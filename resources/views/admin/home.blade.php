            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body">
                        <div class="media">
                            <div class="me-3">
                                <img src="/admin_assets/images/users/avatar-1.jpg" alt=""
                    ...
                    <div class="card-header bg-transparent border-bottom">
                        <div class="d-flex flex-wrap">
                            ...
                            <ul class="nav nav-tabs nav-tabs-custom card-header-tabs ms-auto"
                                role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#post-recent"
                                        role="tab">
                                        Recent
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#post-popular"
                                        role="tab">
                                        Popular
                                    </a>
                                </li>
                                ...
                                <div class="tab-pane active" id="post-recent" role="tabpanel">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item py-3">
                                            <div class="d-flex">
                                                <div class="me-3">
                                                    <img src="/admin_assets/images/small/img-2.jpg" alt=""
                                                ...
                                                <div class="align-self-center overflow-hidden me-auto">
                                                    <div>
                                                        <h5 class="font-size-14 text-truncate"><a href="#"
                                                                class="text-dark">Beautiful Day with
                                                                Friends</a></h5>
                                                ...
                                                <div class="dropdown ms-2">
                                                    <a class="text-muted dropdown-toggle font-size-14"
                                        ...
                                        <li class="list-group-item py-3">
                                            <div class="d-flex">
                                                <div class="me-3">
                                                    <img src="/admin_assets/images/small/img-6.jpg" alt=""
                                                        class="avatar-md h-auto d-block rounded">
                                                </div>
                                                <div class="align-self-center overflow-hidden me-auto">
                                                    <div>
                                        ...
                                        <li class="list-group-item py-3">
                                            <div class="d-flex">
                                                <div class="me-3">
                                                    <img src="/admin_assets/images/small/img-1.jpg" alt=""
                                                        class="avatar-md h-auto d-block rounded">
                                                </div>
                                                ...
                                                <div class="align-self-center overflow-hidden me-auto">
                                                    <div>
                                                        <h5 class="font-size-14 text-truncate"><a href="#"
                                                                class="text-dark">Riding bike on road</a>
                                                        </h5>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="text-muted">If several languages coalesce, the grammar
                                                of the resulting of the individual</p>
                                            <div>
                        ...
                        <div>
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    <div class="py-2">
                                        <h5 class="font-size-14">California <span
                                                class="float-end">78%</span></h5>
                                ...
                                <li class="list-group-item">
                                    <div class="py-2">
                                        <h5 class="font-size-14">Nevada <span class="float-end">69%</span>
                                        </h5>
                                        <div class="progress animated-progess progress-sm">
                                ...
                                <li class="list-group-item">
                                    <div class="py-2">
                                        <h5 class="font-size-14">Texas <span class="float-end">61%</span>
                                        </h5>
                                        <div class="progress animated-progess progress-sm">
                            ...
                            <ul class="verti-timeline list-unstyled">
                                <li class="event-list active">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <div>
                                                Posted <span class="font-weight-semibold">Beautiful Day with
                                                    Friends</span> blog... <a href="#">View</a>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="event-list">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <div>
                                                Create <span class="font-weight-semibold">Drawing a sketch
                                                    blog</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <tbody>
                                    <tr>
                                        <td style="width: 100px;"><img
                                                src="/admin_assets/images/small/img-2.jpg" alt=""
                                    ...
                                    <tr>
                                        <td><img src="/admin_assets/images/small/img-6.jpg" alt=""
                                                class="avatar-md h-auto d-block rounded"></td>
                                        <td>
                                            <h5 class="font-size-13 text-truncate mb-1"><a href="#"
                                                    class="text-dark">Drawing a sketch</a></h5>
                                    ...
                                    <tr>
                                        <td><img src="/admin_assets/images/small/img-1.jpg" alt=""
                                                class="avatar-md h-auto d-block rounded"></td>
                                        <td>
                                            <h5 class="font-size-13 text-truncate mb-1"><a href="#"
                                    ...
                                    <tr>
                                        <td><img src="/admin_assets/images/small/img-2.jpg" alt=""
                                                class="avatar-md h-auto d-block rounded"></td>
                                        <td>
                                            <h5 class="font-size-13 text-truncate mb-1"><a href="#"
