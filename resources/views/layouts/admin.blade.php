...
<body data-sidebar="dark">
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="index.html" class="logo logo-dark">
                            <span class="logo-sm">
                                <img src="/admin_assets/images/logo.svg" alt="" height="22">
                            </span>
                            <span class="logo-lg">
                        ...
                        <a href="index.html" class="logo logo-light">
                            <span class="logo-sm">
                                <img src="/admin_assets/images/logo-light.svg" alt="" height="22">
                            </span>
                            <span class="logo-lg">
                                <img src="/admin_assets/images/logo-light.png" alt="" height="19">
                            </span>
                        </a>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5">
                                            <div>
                                                <img src="/admin_assets/images/megamenu-img.png" alt=""
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                            ...
                            <img id="header-lang-img" src="/admin_assets/images/flags/us.jpg" alt="Header Language"
                                height="16">
                        </button>
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="en">
                                <img src="/admin_assets/images/flags/us.jpg" alt="user-image" class="me-1" height="12">
                                <span class="align-middle">English</span>
                            </a>
                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="sp">
                                <img src="/admin_assets/images/flags/spain.jpg" alt="user-image" class="me-1"
                                    height="12"> <span class="align-middle">Spanish</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="gr">
                                <img src="/admin_assets/images/flags/germany.jpg" alt="user-image" class="me-1"
                                    height="12"> <span class="align-middle">German</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="it">
                                <img src="/admin_assets/images/flags/italy.jpg" alt="user-image" class="me-1"
                                    height="12"> <span class="align-middle">Italian</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ru">
                                <img src="/admin_assets/images/flags/russia.jpg" alt="user-image" class="me-1"
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                            ...
                            <div data-simplebar style="max-height: 230px;">
                                ...
                                <a href="#" class="text-reset notification-item">
                                    <div class="media">
                                        <img src="/admin_assets/images/users/avatar-4.jpg"
                                            class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="media-body">
    ...
    <div class="right-bar">
        <div data-simplebar class="h-100">
            ...
            <div class="p-4">
                <div class="mb-2">
                    <img src="/admin_assets/images/layouts/layout-1.jpg" class="img-fluid img-thumbnail" alt="">
                </div>
                ...
                <div class="mb-2">
                    <img src="/admin_assets/images/layouts/layout-2.jpg" class="img-fluid img-thumbnail" alt="">
                </div>
                <div class="form-check form-switch mb-3">
                    <input class="form-check-input theme-choice" type="checkbox" id="dark-mode-switch"
                        data-bsStyle="/admin_assets/css/bootstrap-dark.min.css"
                        data-appStyle="/admin_assets/css/app-dark.min.css">
                ...
                <div class="form-check form-switch mb-5">
                    <input class="form-check-input theme-choice" type="checkbox" id="rtl-mode-switch"
                        data-appStyle="/admin_assets/css/app-rtl.min.css">
    ...
    <!-- dashboard blog init -->
    <script src="/admin_assets/js/pages/dashboard-blog.init.js"></script>
